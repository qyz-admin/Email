...
// @match    https://business.facebook.com/latest/inbox/all?asset_id*
...
// @downloadURL  https://qyz-admin.github.io/Email/FB-2023.6.js
// @updateURL    https://qyz-admin.github.io/Email/FB-2023.6.js
// @grant    none
// ==/UserScript==
       ...
       function SubmitAB() {//正在刷新网页详细内容
              if(document.readyState =="complete"){//确定是否加载完成
                 ...
                 if(cod99.search(/selected_item_id/i) == "-1"){
                    ...
                    var targNode =document.getElementsByClassName('xeuugli x2lwn1j x6s0dn4 x78zum5 x1q0g3np x1iyjqo2 xs83m0k xozqiw3 x19lwn94 xl56j7k');
                   for(var i=0; i<targNode.length;i++){
                            //   console.log(targNode[i]);
                            //   console.log(targNode[i].firstElementChild.firstElementChild);
                            //   console.log(770077);
                       var tags_val = targNode[i].firstElementChild.firstElementChild.innerText;
                           //      console.log(tags_val);
                           //      console.log(11299222);
                      if (tags_val == "Facebook 回應" || tags_val == "Messenger") {
                               var message = targNode[i].childElementCount;
                            //       console.log('you');
                            //       console.log( message);
                                 if (message == 2){
                                     var ct = 1;
