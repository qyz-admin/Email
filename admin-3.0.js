...
<input type="hidden" value="森鸿自发 &nbsp " class="tool-action btn yellow" id="T_search" >\
 ...
 document.getElementById("ip_search").addEventListener("click", function fnn() { // ip筛选
             ...
             var myAarry= new Array("106.107.251.46","123.193.134.179","123.241.109.171","42.77.190.145","223.136.23.172","36.229.132.64","1.175.2.75","1.173.60.30","110.28.194.201","1.173.48.155","114.41.0.86","114.25.81.248","10.210.44.58");
