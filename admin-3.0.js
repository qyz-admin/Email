  ...
  //  func(a);
      var checkUser = document.getElementsByClassName("username username-hide-on-mobile")[0];
       ...
       if ( checkUser.innerText == "qiyuanzhang@jikeyin.com"){
            ...
            console.log(2222);
                 fun_nav();
          }else if ( checkUser.innerText == "cakeke@jikeyin.com"){
            console.log(2222);
                 fun_nav();
          }else{
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    var wxzSearchBarNode = document.createElement('div');
      ...
      '<input placeholder=" 輸入--（編號）" class="search-button" id="wxz_input" type="hidden">\
       ...
       &nbsp &nbsp\
                   ...
                   <input type="button" value="信息表显示" class="btn green" id="xxb_searchButton">\
                   <input type="button" value="open订单窗口" class="btn green" id="test_searchButton">&nbsp&nbsp&nbsp\
    ...
    var wxzSearchBarNode = document.createElement('div');
      ...
      '<input placeholder=" 輸入--（編號）" class="search-button" id="wxz_input" type="hidden">\
       ...
       &nbsp &nbsp\
                   ...
                   <input type="button" value="open订单窗口" class="btn green" id="test_searchButton">&nbsp&nbsp&nbsp\
     <input type="button" value="待审核設置 &nbsp " class="tool-action btn yellow" id="demo_search" >&nbsp&nbsp\
     <input type="button" value="待发货設置 &nbsp " class="tool-action btn yellow" id="T_search" >&nbsp&nbsp\
     <input type="button" value="姓名 核实" class="btn yellow-gold" id="name_search" >\
     <input type="button" value="地址 核实" class="btn yellow-gold" id="address_search" >\
     <input type="button" value="邮箱 核实" class="btn yellow-gold" id="email_search" >\
     <input type="button" value="金额 核实" class="btn yellow-gold" id="jine_search" >\
     <input type="button" value="留言 核实" class="btn yellow-gold" id="liuyan_search" >&nbsp&nbsp&nbsp\
     <input type="button" value="IP 核实" class="btn yellow-gold" id="ip_search" >\
     <input type="button" value="sku 核实" class="btn yellow-gold" id="sku_search" >\
                                 <input value="信息55" class="btn green" id="xxbb_searchButton" type="hidden">\
      &nbsp &nbsp\
     <input type="button" value="筛选" class="btn green" id="xx_searchButton" >\
                   <input type="button" value="导 出" class="tool-action btn yellow" id="save_searchButton">\
 ...
 document.getElementById("ip_search").addEventListener("click", function fnn() { // ip筛选
             ...
             var myAarry= new Array("106.107.251.46","123.193.134.179","123.241.109.171","42.77.190.145","223.136.23.172","36.229.132.64","1.175.2.75","1.173.60.30","110.28.194.201");
...
<li class="nav-item">\
            ...
            <span class="title"></span>\
             ...
             <li id="demo_tab1" class="nav-item  " target="_blank">\
                   ...
                   <i class="iconfont"></i>\
                   <span class="title" style = "color:red">信息表</span>\
                   </a>\
            </li>\
                           <li class="nav-item  ">\
