// ==UserScript==
// @name    FB-2023.05.16.2
// @namespace  http://tampermonkey.net/
// @version  2023.05.16.2
...
// @downloadURL  https://qyz-admin.github.io/Email/FB-2023.js
// @updateURL    https://qyz-admin.github.io/Email/FB-2023.js
// @grant    none
// ==/UserScript==
...
function yemian(){ //正在加载网页标题内容（二）
  ...
  var wxzSearchBarNode = document.createElement('div');
     ...
     wxzSearchBarNode.innerHTML =
       ...
       +' <input type="button" value="90" class="search-button" id="wxz100_searchButton" title=" 40-90 ">&nbsp'
       +' <input type="button" value="150" class="search-button" id="wxz150_searchButton" title=" 90-150 ">&nbsp'
    ...
    +' <input class="search-query" autocomplete="off" placeholder="点击加载主页" id="jiazai_input" style="text-align: center;width: 100px;" title="请点击显示更多主页">'
...
document.getElementById("wxz150_searchButton").addEventListener("click", function fn() {//等于90-150直接打开页面
 ...
 //---------------------------------------------------------------------------------------------------------------------------------------------------------
document.getElementById("wxz_input").addEventListener("click", function fn() {//等于 输入 直接打开页面
    var input_Valuee = document.getElementById("wxz_input").value;
     tem_wx(0,input_Valuee)
},false);
 //---------------------------------------------------------------------------------------------------------------------------------------------------------
