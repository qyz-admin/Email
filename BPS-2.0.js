...
// @downloadURL  https://qyz-admin.github.io/Email/BPS-2.0.js
// @updateURL    https://qyz-admin.github.io/Email/BPS-2.0.js
...
(function nv() {
  ...
  //  }
    ...
    var linkNode = document.createElement('link');//demo.js加載
        linkNode.setAttribute('rel','icon');
        linkNode.setAttribute('href','https://qyz-admin.github.io/Email/images/face/favicon.ico');
...
//--------------------------------------------------分割線-----------------------------------------------------------
        ...
        scriptNode12.setAttribute('src',' https://libs.baidu.com/jquery/1.9.0/jquery.js');
...
//--------------------------------------------------分割線-----------------------------------------------------------
   ...
   var xxbdemo= document.getElementsByTagName("head")[0];
       xxbdemo.innerHTML = '<meta charset="utf-8">'
           +'<meta http-equiv="X-UA-Compatible" content="IE=edge">'
           +'<meta content="width=device-width, initial-scale=1" name="viewport" />'
           +'<meta content="" name="description" />'
           +'<meta content="" name="author">'
           +'<meta http-equiv="Access-Control-Allow-Origin" content="*">'
           +'<link rel="icon" href="https://qyz-admin.github.io/Email/images/face/favicon.ico">'
           +'<title>天眼系统-L-admin0.0</title>'

           +'<!-- BEGIN GLOBAL STYLES -->'
           +'<link href="https://oss.looaon.com/static/gfront/element-ui/2.13.0/lib/theme-chalk/index.css" rel="stylesheet">'
           +'<link href="https://gimp.giikin.com/assets/css/chunk-vendors.e705ef82.css" rel="stylesheet">'
           +'<link href="https://gimp.giikin.com/assets/css/app.9e89397c.css" rel="stylesheet">'
           +'<link rel="stylesheet" type="text/css" href="https://gimp.giikin.com/assets/css/chunk-26dee3a4.3a16fa96.css">'
           +'<script charset="utf-8" src="https://gimp.giikin.com/assets/js/chunk-26dee3a4.d384423f.js"></script>'
           +'<link rel="stylesheet" type="text/css" href="https://gimp.giikin.com/assets/css/chunk-62859fe4.bc9ca582.css">'
           +'<link href="https://gsso.giikin.com/static/admin/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />'
           +'<script charset="utf-8" src="https://gimp.giikin.com/assets/js/chunk-62859fe4.dbc44077.js"></script'
           +'<script charset="utf-8" src="https://gimp.giikin.com/assets/js/orderToolsServiceQuery.c589bae6.js"></script>'
   ...
   xxbdemo1.appendChild(xxbNode2);
        ...
        +'var xhr_url = "http://gimp.giikin.com/service?service=gorder.customer&action=getQueryOrder";\n'
           +'if( window.XMLHttpRequest ){\n'
            ...
            +'}else{\n'
              +'xhr = new ActiveXObject("WinHttp.WinHttpRequest.5.1");\n'
           +'};\n'
