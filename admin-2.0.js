...
// @downloadURL  https://qyz-admin.github.io/Email/admin-2.0.js
// @updateURL    https://qyz-admin.github.io/Email/admin-2.0.js
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  function fn_nav() {//导航加载
    ...
    var wxzSearchBarNode = document.createElement('div');
        ...
        wxzSearchBarNode.style = "position: absolute;float: left;top: 10px; left: 235px;width:1745px;";//left:235
        wxzSearchBarNode.innerHTML =
      '<input placeholder=" 輸入--（編號）" class="search-button btn-sm" id="wxz_input" type="hidden">\
                   <input type="button" value="关闭" class="btn default showcol btn-sm" id="close_searchButton" style="width: 45px;text-align: left;">\
 &nbsp\
             ...
             for (var i = 0, ii = ip_val.length; i < ii; i++) {
                      ...
                      for (var j = 0; j < cout; j++) {
                             ...
                             var splitVal = iptxt.split(".")[0];
                               if(splitVal>900){
                                  var dataneme = countVal.rows[j].cells[1].innerHTML;
                                         data = data + dataneme +";大于900-----" + iptxt +";-----           " + "\n" + "\n";
                                }else{
