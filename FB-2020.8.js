...
// @downloadURL  https://qyz-admin.github.io/Email/FB-2020.8.js
// @updateURL    https://qyz-admin.github.io/Email/FB-2020.8.js
// @grant    none
// ==/UserScript==
/*
...
//      '<input type="button" value="暫時" class="search-button" id="zss_searchButton" >'
  ...
  var wxzSearchBarNode = document.createElement('div');
     ...
     wxzSearchBarNode.innerHTML =
        ' <input type="button" value="通知" class="search-button" id="tz_searchButton" > '
       +' <input class="search-query" autocomplete="off" placeholder="查詢--數量" id="wxz_input" style="text-align: center;width: 100px;">'
...
//-----------------------------------------------------------------------------------------公用函數--------------------------------------------------------------
 ...
 //--------------------------------------------------------------------------------------------------------------------------------------------
  document.getElementById("tz_searchButton").addEventListener("click", function fn() {//通知信息打開
