...
// @downloadURL  https://qyz-admin.github.io/Email/FB-10.2.js
// @updateURL    https://qyz-admin.github.io/Email/FB-10.2.js
// @grant    none
// ==/UserScript==
(function() {
  ...
  wxzSearchBarNode.innerHTML =
      ' <input type="button" value="暫時" class="search-button" id="zss_searchButton" >\
       ...
       <input type="button" value="20" class="search-button" id="wxz20_searchButton" >0-20\
       <input type="button" value="25" class="search-button" id="wxz25_searchButton" >25以上\
       <input type="button" value="40" class="search-button" id="wxz40_searchButton" >20-40\
           <input type="button" value="60" class="search-button" id="wxz60_searchButton" >40-60\
           <input type="button" value="80" class="search-button" id="wxz80_searchButton" >60-80\
           <input type="button" value="100" class="search-button" id="wxz100_searchButton" >80-100\;'
 ...
 //---------------------------------------------------------------------------------------------------------------------------------------------------------
  document.getElementById("wxz_searchButton").addEventListener("click", function fn() {//小于20直接打开页面
  ...
  function getElementByClassName(classnames){
    ...
    var inputValue = document.getElementById("wxz_input").value;
      var inputValuee = document.getElementById("wxz20_searchButton").getAttribute("value");
      var inputValueee = document.getElementById("wxz25_searchButton").getAttribute("value");
if(inputValue == null || inputValue == ""){
  ...
  }else if(objArray.length>20){
     alert("數量 : "+objArray.length+" ; 請分別點擊 20,； 25，按鈕分兩次打開頁面 ");
  };
}else{
 ...
 //---------------------------------------------------------------------------------------------------------------------------------------------------------
  document.getElementById("wxz25_searchButton").addEventListener("click", function fn() {//大于25直接打开页面
  var objArray= new Array();
  var index = 0;
  function getElementByClassName(classnames){
    var tags=document.getElementsByTagName("*");
...
if(objArray.length>20){
     if(inputValueee > 20){
      for(var n=20; n<objArray.length;n++){
 ...
 //---------------------------------------------------------------------------------------------------------------------------------------------------------
 document.getElementById("wxz20_searchButton").addEventListener("click", function fn() {//等于20-直接打开页面
  var objArray= new Array();
  var index = 0;
  function getElementByClassName(classnames){
    var tags=document.getElementsByTagName("*");
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
    document.getElementById("wxz40_searchButton").addEventListener("click", function fn() {//40直接打开页面
  var objArray= new Array();
  var index = 0;
  function getElementByClassName(classnames){
    var tags=document.getElementsByTagName("*");
    ...
    while (true) {
      ...
      var inputValue40 = document.getElementById("wxz40_searchButton").getAttribute("value");
if(objArray.length>20){
     if(inputValue40 > 20){
      for(var n=20; n<inputValue40;n++){
        var conmand=objArray[n];
        var vraa=document.createElement('a');
        vraa.target='_blank';
        vraa.href=conmand;
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------
    document.getElementById("wxz60_searchButton").addEventListener("click", function fn() {//60直接打开页面
  var objArray= new Array();
  var index = 0;
  function getElementByClassName(classnames){
    var tags=document.getElementsByTagName("*");
...
*/
  ...
  function shuaxinTab() {
    ...
    document.getElementById("zss_searchButton").addEventListener("click", function fn() {//100直接打开页面
         setTimeout(function () {
            var cod2=window.location.href;
                    cod2=cod2.replace(/notifications/,"inbox");
                var vraa2=document.createElement('a');
                    vraa2.target='_self';
                    vraa2.href=cod2;
                    document.body.appendChild(vraa2);
                    vraa2.click();
        }, 100);
