...
// @downloadURL  https://qyz-admin.github.io/Email/admin-9.0.js
// @updateURL    https://qyz-admin.github.io/Email/admin-9.0.js
  ...
  function fn_nav() {//导航加载-带导出功能
    ...
    var wxzSearchBarNode = document.createElement('div');
      ...
      '<input placeholder=" 輸入--（編號）" class="search-button btn-sm" id="wxz_input" type="hidden">\
       ...
       &nbsp &nbsp\
                   ...
                   <input type="button" value="运单号查询" class="btn default showcol btn-sm" id="waybill_searchButton" >\
                   <input type="button" value="金額查询" class="btn default showcol btn-sm" id="cd_searchButton" >\
                                 ...
                                 <input value="查詢-補發" class="btn default showcol btn-sm" id="wxz_searchButton" type="hidden">&nbsp &nbsp\
   ...
   <input type="hidden" value="待审核設置 &nbsp " class="btn yellow-gold btn-sm" id="demo_search" >\
    &nbsp &nbsp\
                   ...
                   <input type="button" value="一键复制" class="btn green btn-sm" id="yi_searchButton">&nbsp &nbsp\
...
function daochu(){
     var targNode = document.getElementById("header-nav");
     var show_tab = document.getElementById("save_searchButton");
            console.log(targNode);console.log(show_tab);
...
//=---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  document.getElementById("yi_searchButton").addEventListener("click", function fn() {//一鍵複製
     ...
     var thNode111 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementById("tc-info");
           console.log(thNode111.children.length);
     var thNodeLen = thNode111.children.length;
  if(thNodeLen == 1){
    var text= document.getElementById("tab_iframe_客服查询").contentDocument.getElementById("tc-info").innerText;
           console.log(text);
  ...
  //          layer.msg('Hello 复制成功', {icon: 3});
   ...
   //         layer.msg('Hello 复制成功', {icon: 5});
    ...
    var text0= document.getElementById("tab_iframe_客服查询").contentDocument.getElementById("tc-info").innerText;
           console.log(text0);
...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
document.getElementById("ffz_searchButton").addEventListener("click", function fn() {//复制
            var thNode111 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementById("thvalue");
           console.log(thNode111.children.length);
        var thNodeLen = thNode111.children.length;
  if(thNodeLen == 1){
    ...
    document.getElementById("waybill_searchButton").addEventListener("click", function fn() {//快捷-运单号查詢
         //var wxcxTable = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByTagName("tbody");
          ...
          var wxcxTable1 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByTagName("thead")[0];
              wxcxTable1.parentNode.removeChild(wxcxTable1);
             var thNode101 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByClassName("table table-striped table-bordered table-hover")[0];
             var thNode203 = document.createElement('colgroup');
                 thNode203.innerHTML = '<col width="65"><col width="94"><col width="94"><col width="94"><col width="94"><col width="129"><col width="94"><col width="80"><col width="57"><col width="94"><col width="57"><col width="57"><col width="94"><col width="129">'
                 thNode101.append(thNode203);
                var thNode202 = document.createElement('thead');
                    thNode202.innerHTML =
                                       "<tr>"
                                          + "<th> 订单号  </th>"
...
//var thNode1 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByClassName("table table-striped table-bordered table-hover")[0];
     ...
     function dcountSum() {
       ...
       var countSum = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByTagName("tbody")[0];
           countVal0.innerHTML= '查询结果<font color="#FF5722">（总计：'+ countSum.children.length +' 单）</font>';
         ...
         //var wxcxTable = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByTagName("tbody");
          ...
          var wxcxTable1 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByTagName("thead")[0];
              wxcxTable1.parentNode.removeChild(wxcxTable1);
                var thNode101 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByClassName("table table-striped table-bordered table-hover")[0];
          var thNode203 = document.createElement('colgroup');
              thNode203.innerHTML = '<col width="85"><col width="94"><col width="94"><col width="94"><col width="94"><col width="129"><col width="94"><col width="57"><col width="57"><col width="57"><col width="94"><col width="57"><col width="300">'
              thNode101.append(thNode203);
                var thNode202 = document.createElement('thead');
                    thNode202.innerHTML =
                                       "<tr>"
...
//var thNode1 = document.getElementById("tab_iframe_客服查询").contentDocument.getElementsByClassName("table table-striped table-bordered table-hover")[0];
    ...
    /*
    <div class="row"><div class="col-md-5 col-sm-5"><div class="dataTables_info" id="DataTable_info" role="status" aria-live="polite">显示第 0 至 0 项结果，共 0 项</div></div></div>
